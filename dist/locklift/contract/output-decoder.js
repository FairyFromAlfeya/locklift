...
class OutputDecoder {
    ...
    decode() {
        const outputDecoded = this.decodeTuple(this.output, this.functionAttributes.outputs);
...
exports.OutputDecoder = OutputDecoder;
//# sourceMappingURL=output-decoder.js.map