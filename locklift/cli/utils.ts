...
export function checkDirEmpty(dir) {
...
export function initializeDirIfNotExist(dir) {
  if (!fs.existsSync(dir)) {
    fs.mkdirSync(dir);
  }
}

export function flatDirTree(tree) {
...
export class Builder {
  ...
  constructor(private config, private options) {}
